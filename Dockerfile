...
# supervisord
RUN yum clean all && rm -r /var/cache/yum && yum install -y python python-setuptools python-setuptools-devel && easy_install pip && pip install pip --upgrade && pip install supervisor
